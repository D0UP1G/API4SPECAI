...
def yagpt_2nd(userprompt,temp=0.5,model='yandexgpt/latest'):
    prompt = {
...
def yagpt_2nd_2(userprompt,temp=0.5,model='yandexgpt/latest'):
    prompt = {
        "modelUri": "gpt://b1g5du6ksd646nmsi6do/"+model,
        "completionOptions": {
            "stream": False,
...
def get_seo(sour): # это основная функция 
    res=yagpt_2nd(sour,temp=0.75)
    res2=yagpt_2nd_2(res,temp=0.75)
    return [res,res2] 
